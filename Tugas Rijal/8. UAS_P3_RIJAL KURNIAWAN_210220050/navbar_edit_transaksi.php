...
<table class="table table-bordered" border="1">
    ...
    <tr>
		<td>Diskon</td>
		<td><input type="number" name="diskon" class="form-control" required value="<?php echo $data ['diskon'];?>"></td>
	</tr>
    <tr>
		<td>Id Pelanggan</td>
		<td><select name="id_pelanggan" class="form-control" required>
			<option value="<?php echo $data ['id_pelanggan'];?>">-----Pilih-----</option>
			<?php 
