						...
						<li>
							...
							<ul class="nav nav-second-level collapse">
								...
								<li>
      							...
      							<li>
									<a href="input_pelanggan.php">Input Pelanggan</a>
								</li>
								<li>
        						...
        						<li>
       							...
       							<li>
									<a href="tampil_pelanggan.php">Daftar Pelanggan</a>
								</li>
								<li>
...
<form method="POST">
	<table>
		<tr>
		<td>Cari Nama Pelanggan</td>
		</tr>
		<tr>
			<td><input type="text" name="rijalkurniawan"></td>
		</tr>
		<tr>
			<td><input type="submit" name="cari" value="Cari" onClick='top.location="tampil_pelanggan.php"'class='btn btn-danger'></td>
		</tr>
	</table>
</form>
...
<input type='button'value='Refresh'onClick='top.location="tampil_pelanggan.php"'class='btn btn-danger'>


<!--footer-->
<div class="footer">
<p>&copy; 2023 CUPCUP Supermarket | Design by <a href="#" target="_blank">RK</a></p>
</div>
<!--//footer-->
</div>
<!-- Classie -->
