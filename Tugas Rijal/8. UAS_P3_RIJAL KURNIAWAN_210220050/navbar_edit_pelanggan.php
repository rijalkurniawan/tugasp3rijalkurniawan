...
<div id="page-wrapper">
<div class="main-page">
<h1><center> UPDATE PELANGGAN</center></h1>
<br>
<form method="POST">
<table class="table table-bordered" border="1">
	<tr>
		...
		<td><input type="text" name="nama_pelanggan" class="form-control" required value="<?php echo $data['nama_pelanggan'];?>"></td>
	</tr>
	<tr>
		<td>Nomor Telepon</td>
		<td><input type="text" name="no_tlp" class="form-control" required value="<?php echo $data['no_tlp'];?>"></td>
	</tr>
	<tr>
		<td>Status</td>
